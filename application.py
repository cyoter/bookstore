...
def index():
    ...
    <p>“A good bookshop is just a genteel Black Hole that knows how to read.”</p>
    <footer class="blockquote-footer">Terry Pratchett, Guards! Guards! </footer>
  </blockquote>""")
    session["books"]=[]   
...
def bookpage(isbn):
    ...
    res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "zuchoEZeUysjW5Q6A7AW1A", "isbns": isbn})
